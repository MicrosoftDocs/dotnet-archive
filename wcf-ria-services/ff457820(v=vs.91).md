---
title: SaveUserOperation Events (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: SaveUserOperation Events
ms:assetid: Events.T:System.ServiceModel.DomainServices.Client.ApplicationServices.SaveUserOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.saveuseroperation_events(v=VS.91)
ms:contentKeyID: 28898932
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# SaveUserOperation Events
