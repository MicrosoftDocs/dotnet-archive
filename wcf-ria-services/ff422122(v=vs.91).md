---
title: LoadOperation Methods (System.ServiceModel.DomainServices.Client)
TOCTitle: LoadOperation Methods
ms:assetid: Methods.T:System.ServiceModel.DomainServices.Client.LoadOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.loadoperation_methods(v=VS.91)
ms:contentKeyID: 28754597
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# LoadOperation Methods
...
The [LoadOperation](ff422941\(v=vs.91\).md) type exposes the following members.
