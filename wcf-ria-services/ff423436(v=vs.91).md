---
title: InvokeOperation(TValue) Events (System.ServiceModel.DomainServices.Client)
TOCTitle: InvokeOperation(TValue) Events
ms:assetid: Events.T:System.ServiceModel.DomainServices.Client.InvokeOperation`1
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Ff423436(v=VS.91)
ms:contentKeyID: 28755791
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# InvokeOperation\<TValue\> Events
