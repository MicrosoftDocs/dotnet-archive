---
title: DomainServiceContext Class (System.ServiceModel.DomainServices.Server)
TOCTitle: DomainServiceContext Class
ms:assetid: T:System.ServiceModel.DomainServices.Server.DomainServiceContext
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.server.domainservicecontext(v=VS.91)
ms:contentKeyID: 28755755
ms.date: 01/27/2012
...
Represents the execution environment for the operations performed by a [DomainService](ff422911\(v=vs.91\).md).
...
<td><a href="ff423300(v=vs.91).md">DomainServiceContext</a></td>
<td>Initializes a new instance of the DomainServiceContext class.</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><img src="images\Ff423329.pubmethod(en-us,VS.91).gif" title="Public method" alt="Public method" /></td>
<td><a href="ff422477(v=vs.91).md">GetService</a></td>
