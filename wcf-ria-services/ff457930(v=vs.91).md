---
title: WindowsAuthentication Properties (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: WindowsAuthentication Properties
ms:assetid: Properties.T:System.ServiceModel.DomainServices.Client.ApplicationServices.WindowsAuthentication
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.windowsauthentication_properties(v=VS.91)
ms:contentKeyID: 28899041
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# WindowsAuthentication Properties
