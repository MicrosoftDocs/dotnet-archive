---
title: WindowsAuthentication.SaveUser Method  (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: SaveUser Method
ms:assetid: Overload:System.ServiceModel.DomainServices.Client.ApplicationServices.WindowsAuthentication.SaveUser
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.windowsauthentication.saveuser(v=VS.91)
ms:contentKeyID: 28898893
ms.date: 01/27/2012
mtps_version: v=VS.91
f1_keywords:
- System.ServiceModel.DomainServices.Client.ApplicationServices.WindowsAuthentication.SaveUser
dev_langs:
- CSharp
- JScript
- VB
...
# WindowsAuthentication.SaveUser Method
