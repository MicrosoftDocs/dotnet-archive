---
title: LoadOperation Events (System.ServiceModel.DomainServices.Client)
TOCTitle: LoadOperation Events
ms:assetid: Events.T:System.ServiceModel.DomainServices.Client.LoadOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.loadoperation_events(v=VS.91)
ms:contentKeyID: 28754865
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# LoadOperation Events
