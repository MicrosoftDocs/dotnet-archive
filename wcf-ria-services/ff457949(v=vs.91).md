---
title: AuthenticationDomainContextBase Methods (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: AuthenticationDomainContextBase Methods
ms:assetid: Methods.T:System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.authenticationdomaincontextbase_methods(v=VS.91)
ms:contentKeyID: 28899061
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# AuthenticationDomainContextBase Methods
