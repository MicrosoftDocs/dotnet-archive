---
title: AuthenticationOperation Properties (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: AuthenticationOperation Properties
ms:assetid: Properties.T:System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.authenticationoperation_properties(v=VS.91)
ms:contentKeyID: 28899096
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# AuthenticationOperation Properties
...
The [AuthenticationOperation](ff457816\(v=vs.91\).md) type exposes the following members.
