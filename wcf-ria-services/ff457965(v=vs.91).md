---
title: WebAuthenticationService.SaveUser Method  (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: SaveUser Method
ms:assetid: Overload:System.ServiceModel.DomainServices.Client.ApplicationServices.WebAuthenticationService.SaveUser
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.webauthenticationservice.saveuser(v=VS.91)
ms:contentKeyID: 28899077
ms.date: 01/27/2012
mtps_version: v=VS.91
f1_keywords:
- System.ServiceModel.DomainServices.Client.ApplicationServices.WebAuthenticationService.SaveUser
dev_langs:
- CSharp
- JScript
- VB
...
# WebAuthenticationService.SaveUser Method
