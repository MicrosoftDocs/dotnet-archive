---
title: AuthenticationOperation Methods (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: AuthenticationOperation Methods
ms:assetid: Methods.T:System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.authenticationoperation_methods(v=VS.91)
ms:contentKeyID: 28899015
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# AuthenticationOperation Methods
