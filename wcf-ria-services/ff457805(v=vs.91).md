---
title: LogoutOperation Properties (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: LogoutOperation Properties
ms:assetid: Properties.T:System.ServiceModel.DomainServices.Client.ApplicationServices.LogoutOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.logoutoperation_properties(v=VS.91)
ms:contentKeyID: 28898917
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# LogoutOperation Properties
...
The [LogoutOperation](ff457967\(v=vs.91\).md) type exposes the following members.
