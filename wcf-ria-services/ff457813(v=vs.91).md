---
title: LogoutOperation Events (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: LogoutOperation Events
ms:assetid: Events.T:System.ServiceModel.DomainServices.Client.ApplicationServices.LogoutOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.logoutoperation_events(v=VS.91)
ms:contentKeyID: 28898925
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# LogoutOperation Events
