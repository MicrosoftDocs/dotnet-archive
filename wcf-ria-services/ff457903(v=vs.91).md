---
title: SaveUserOperation Class (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: SaveUserOperation Class
ms:assetid: T:System.ServiceModel.DomainServices.Client.ApplicationServices.SaveUserOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.saveuseroperation(v=VS.91)
ms:contentKeyID: 28899014
ms.date: 01/27/2012
...
Represents the operation type returned from SaveUser operations on [AuthenticationService](ff457927\(v=vs.91\).md).
