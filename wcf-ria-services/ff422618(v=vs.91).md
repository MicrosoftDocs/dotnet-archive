---
title: LoadOperation(TEntity) Methods (System.ServiceModel.DomainServices.Client)
TOCTitle: LoadOperation(TEntity) Methods
ms:assetid: Methods.T:System.ServiceModel.DomainServices.Client.LoadOperation`1
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Ff422618(v=VS.91)
ms:contentKeyID: 28754990
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# LoadOperation\<TEntity\> Methods
