---
title: CreateRiaClientFilesTask.LogWarning Method  (Microsoft.ServiceModel.DomainServices.Tools)
TOCTitle: LogWarning Method
ms:assetid: Overload:Microsoft.ServiceModel.DomainServices.Tools.CreateRiaClientFilesTask.LogWarning
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.servicemodel.domainservices.tools.createriaclientfilestask.logwarning(v=VS.91)
ms:contentKeyID: 43894596
ms.date: 01/27/2012
mtps_version: v=VS.91
f1_keywords:
- Microsoft.ServiceModel.DomainServices.Tools.CreateRiaClientFilesTask.LogWarning
dev_langs:
- CSharp
- JScript
- VB
...
# CreateRiaClientFilesTask.LogWarning Method
