---
title: LoadUserOperation Events (System.ServiceModel.DomainServices.Client.ApplicationServices)
TOCTitle: LoadUserOperation Events
ms:assetid: Events.T:System.ServiceModel.DomainServices.Client.ApplicationServices.LoadUserOperation
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.servicemodel.domainservices.client.applicationservices.loaduseroperation_events(v=VS.91)
ms:contentKeyID: 28899070
ms.date: 01/27/2012
mtps_version: v=VS.91
---

# LoadUserOperation Events
