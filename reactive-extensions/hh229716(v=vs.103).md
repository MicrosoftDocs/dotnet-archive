---
title: Observable.ToAsync(T1, T2, T3, T4, T5, T6, TResult) Method (Func(T1, T2, T3, T4, T5, T6, TResult)) (System.Reactive.Linq)
TOCTitle: ToAsync(T1, T2, T3, T4, T5, T6, TResult) Method (Func(T1, T2, T3, T4, T5, T6, TResult))
ms:assetid: M:System.Reactive.Linq.Observable.ToAsync``7(System.Func{``0,``1,``2,``3,``4,``5,``6})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229716(v=VS.103)
ms:contentKeyID: 36069387
ms.date: 06/28/2011
