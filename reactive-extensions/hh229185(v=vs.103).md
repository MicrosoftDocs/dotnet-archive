---
title: ReplaySubject(T).Subscribe Method  (System.Reactive.Subjects)
TOCTitle: Subscribe Method
ms:assetid: M:System.Reactive.Subjects.ReplaySubject`1.Subscribe(System.IObserver{`0})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229185(v=VS.103)
ms:contentKeyID: 36068601
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Subjects.ReplaySubject`1.Subscribe
dev_langs:
- CSharp
- JScript
- VB
...
#### Parameters
  ...
  - observer  
    Type: [System.IObserver](https://msdn.microsoft.com/en-us/library/Dd783449)\<[T](hh211810\(v=vs.103\).md)\>  
