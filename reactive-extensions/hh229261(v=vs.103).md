---
title: Observable.GroupBy(TSource, TKey) Method (IObservable(TSource), Func(TSource, TKey), IEqualityComparer(TKey)) (System.Reactive.Linq)
TOCTitle: GroupBy(TSource, TKey) Method (IObservable(TSource), Func(TSource, TKey), IEqualityComparer(TKey))
ms:assetid: M:System.Reactive.Linq.Observable.GroupBy``2(System.IObservable{``0},System.Func{``0,``1},System.Collections.Generic.IEqualityComparer{``1})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229261(v=VS.103)
ms:contentKeyID: 36068676
ms.date: 06/28/2011
