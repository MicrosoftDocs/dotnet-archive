---
title: Qbservable.ToDictionary(TSource, TKey) Method (IQbservable(TSource), Expression(Func(TSource, TKey))) (System.Reactive.Linq)
TOCTitle: ToDictionary(TSource, TKey) Method (IQbservable(TSource), Expression(Func(TSource, TKey)))
ms:assetid: M:System.Reactive.Linq.Qbservable.ToDictionary``2(System.Reactive.Linq.IQbservable{``0},System.Linq.Expressions.Expression{System.Func{``0,``1}})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229661(v=VS.103)
ms:contentKeyID: 36069076
ms.date: 06/28/2011
