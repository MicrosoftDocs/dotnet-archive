---
title: BehaviorSubject(T).Dispose Method  (System.Reactive.Subjects)
TOCTitle: Dispose Method
ms:assetid: M:System.Reactive.Subjects.BehaviorSubject`1.Dispose
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229421(v=VS.103)
ms:contentKeyID: 36068838
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Subjects.BehaviorSubject`1.Dispose
dev_langs:
- CSharp
- JScript
- VB
