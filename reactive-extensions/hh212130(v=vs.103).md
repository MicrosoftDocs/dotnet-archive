---
title: Observable.Buffer(TSource) Method (IObservable(TSource), Int32) (System.Reactive.Linq)
TOCTitle: Buffer(TSource) Method (IObservable(TSource), Int32)
ms:assetid: M:System.Reactive.Linq.Observable.Buffer``1(System.IObservable{``0},System.Int32)
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh212130(v=VS.103)
ms:contentKeyID: 36069828
ms.date: 06/28/2011
