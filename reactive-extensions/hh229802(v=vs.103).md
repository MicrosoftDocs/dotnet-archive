---
title: BehaviorSubject(T) Constructor  (System.Reactive.Subjects)
TOCTitle: BehaviorSubject(T) Constructor
ms:assetid: M:System.Reactive.Subjects.BehaviorSubject`1.#ctor(`0)
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229802(v=VS.103)
ms:contentKeyID: 36069473
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Subjects.BehaviorSubject`1.#ctor
- System.Reactive.Subjects.BehaviorSubject`1.BehaviorSubject
dev_langs:
- CSharp
- JScript
- VB
...
Initializes a new instance of the [BehaviorSubject\<T\>](hh211949\(v=vs.103\).md) class which creates a subject that caches its last value and starts with the specified value.
