---
title: Observable.Distinct(TSource, TKey) Method (IObservable(TSource), Func(TSource, TKey), IEqualityComparer(TKey)) (System.Reactive.Linq)
TOCTitle: Distinct(TSource, TKey) Method (IObservable(TSource), Func(TSource, TKey), IEqualityComparer(TKey))
ms:assetid: M:System.Reactive.Linq.Observable.Distinct``2(System.IObservable{``0},System.Func{``0,``1},System.Collections.Generic.IEqualityComparer{``1})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229050(v=VS.103)
ms:contentKeyID: 36068467
ms.date: 06/28/2011
