---
title: Qbservable.Timeout(TSource) Method (IQbservable(TSource), TimeSpan, IScheduler) (System.Reactive.Linq)
TOCTitle: Timeout(TSource) Method (IQbservable(TSource), TimeSpan, IScheduler)
ms:assetid: M:System.Reactive.Linq.Qbservable.Timeout``1(System.Reactive.Linq.IQbservable{``0},System.TimeSpan,System.Reactive.Concurrency.IScheduler)
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229861(v=VS.103)
ms:contentKeyID: 36069533
ms.date: 06/28/2011
