---
title: ReplaySubject(T) Methods (System.Reactive.Subjects)
TOCTitle: ReplaySubject(T) Methods
ms:assetid: Methods.T:System.Reactive.Subjects.ReplaySubject`1
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh244286(v=VS.103)
ms:contentKeyID: 36069920
ms.date: 06/28/2011
...
The [ReplaySubject\<T\>](hh211810\(v=vs.103\).md) type exposes the following members.
...
<td>Releases all resources used by the current instance of the <a href="hh211810(v=vs.103).md">ReplaySubject&lt;T&gt;</a> class and unsubscribe all observers.</td>
</tr>
<tr class="even">
<td><img src="images\Hh303103.pubmethod(en-us,VS.103).gif" title="Public method" alt="Public method" /></td>
