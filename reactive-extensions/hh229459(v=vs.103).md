---
title: Pattern(T1, T2, T3, T4, T5, T6, T7, T8, T9) Class (System.Reactive.Joins)
TOCTitle: Pattern(T1, T2, T3, T4, T5, T6, T7, T8, T9) Class
ms:assetid: T:System.Reactive.Joins.Pattern`9
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229459(v=VS.103)
ms:contentKeyID: 36068875
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Joins.Pattern`9
dev_langs:
- CSharp
- JScript
- VB
