---
title: Observable.ToAsync(T1, T2, T3, T4) Method (Action(T1, T2, T3, T4), IScheduler) (System.Reactive.Linq)
TOCTitle: ToAsync(T1, T2, T3, T4) Method (Action(T1, T2, T3, T4), IScheduler)
ms:assetid: M:System.Reactive.Linq.Observable.ToAsync``4(System.Action{``0,``1,``2,``3},System.Reactive.Concurrency.IScheduler)
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229370(v=VS.103)
ms:contentKeyID: 36068786
ms.date: 06/28/2011
