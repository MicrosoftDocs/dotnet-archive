---
title: Subject(T).Subscribe Method  (System.Reactive.Subjects)
TOCTitle: Subscribe Method
ms:assetid: M:System.Reactive.Subjects.Subject`1.Subscribe(System.IObserver{`0})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229065(v=VS.103)
ms:contentKeyID: 36068482
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Subjects.Subject`1.Subscribe
dev_langs:
- CSharp
- JScript
- VB
...
#### Parameters
  ...
  - observer  
    Type: [System.IObserver](https://msdn.microsoft.com/en-us/library/Dd783449)\<[T](hh229173\(v=vs.103\).md)\>  
