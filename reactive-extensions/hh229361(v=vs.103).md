---
title: Observable.ToAsync(T1, T2, T3, T4, T5, T6, T7, T8) Method (Action(T1, T2, T3, T4, T5, T6, T7, T8), IScheduler) (System.Reactive.Linq)
TOCTitle: ToAsync(T1, T2, T3, T4, T5, T6, T7, T8) Method (Action(T1, T2, T3, T4, T5, T6, T7, T8), IScheduler)
ms:assetid: M:System.Reactive.Linq.Observable.ToAsync``8(System.Action{``0,``1,``2,``3,``4,``5,``6,``7},System.Reactive.Concurrency.IScheduler)
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229361(v=VS.103)
ms:contentKeyID: 36068777
ms.date: 06/28/2011
