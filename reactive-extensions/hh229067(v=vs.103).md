---
title: TestScheduler.ScheduleAbsolute Method  (Microsoft.Reactive.Testing)
TOCTitle: ScheduleAbsolute Method
ms:assetid: Overload:Microsoft.Reactive.Testing.TestScheduler.ScheduleAbsolute
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.reactive.testing.testscheduler.scheduleabsolute(v=VS.103)
ms:contentKeyID: 36068484
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- Microsoft.Reactive.Testing.TestScheduler.ScheduleAbsolute
- Microsoft.Reactive.Testing.TestScheduler.ScheduleAbsolute``1
dev_langs:
- CSharp
- JScript
- VB
