---
title: Qbservable.Timestamp(TSource) Method (IQbservable(TSource), IScheduler) (System.Reactive.Linq)
TOCTitle: Timestamp(TSource) Method (IQbservable(TSource), IScheduler)
ms:assetid: M:System.Reactive.Linq.Qbservable.Timestamp``1(System.Reactive.Linq.IQbservable{``0},System.Reactive.Concurrency.IScheduler)
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229542(v=VS.103)
ms:contentKeyID: 36068958
ms.date: 06/28/2011
