---
title: Pattern(T1, T2, T3, T4, T5, T6, T7, T8) Methods (System.Reactive.Joins)
TOCTitle: Pattern(T1, T2, T3, T4, T5, T6, T7, T8) Methods
ms:assetid: Methods.T:System.Reactive.Joins.Pattern`8
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229901(v=VS.103)
ms:contentKeyID: 36069572
ms.date: 06/28/2011
...
The [Pattern\<T1, T2, T3, T4, T5, T6, T7, T8\>](hh229671\(v=vs.103\).md) type exposes the following members.
