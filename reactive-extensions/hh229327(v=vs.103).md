---
title: Observable.ToAsync(T1, T2, TResult) Method (Func(T1, T2, TResult), IScheduler) (System.Reactive.Linq)
TOCTitle: ToAsync(T1, T2, TResult) Method (Func(T1, T2, TResult), IScheduler)
ms:assetid: M:System.Reactive.Linq.Observable.ToAsync``3(System.Func{``0,``1,``2},System.Reactive.Concurrency.IScheduler)
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229327(v=VS.103)
ms:contentKeyID: 36068744
ms.date: 06/28/2011
