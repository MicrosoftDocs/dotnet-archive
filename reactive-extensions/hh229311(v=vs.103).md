---
title: QueryablePattern(T1, T2) Class (System.Reactive.Joins)
TOCTitle: QueryablePattern(T1, T2) Class
ms:assetid: T:System.Reactive.Joins.QueryablePattern`2
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229311(v=VS.103)
ms:contentKeyID: 36068727
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Joins.QueryablePattern`2
dev_langs:
- CSharp
- JScript
- VB
