---
title: Observable.Replay(TSource) Method (IObservable(TSource)) (System.Reactive.Linq)
TOCTitle: Replay(TSource) Method (IObservable(TSource))
ms:assetid: M:System.Reactive.Linq.Observable.Replay``1(System.IObservable{``0})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229288(v=VS.103)
ms:contentKeyID: 36068703
ms.date: 06/28/2011
