---
title: Observable.Buffer(TSource) Method (IObservable(TSource), TimeSpan, TimeSpan) (System.Reactive.Linq)
TOCTitle: Buffer(TSource) Method (IObservable(TSource), TimeSpan, TimeSpan)
ms:assetid: M:System.Reactive.Linq.Observable.Buffer``1(System.IObservable{``0},System.TimeSpan,System.TimeSpan)
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh211715(v=VS.103)
ms:contentKeyID: 36069161
ms.date: 06/28/2011
