---
title: Pattern(T1, T2, T3, T4) Methods (System.Reactive.Joins)
TOCTitle: Pattern(T1, T2, T3, T4) Methods
ms:assetid: Methods.T:System.Reactive.Joins.Pattern`4
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229314(v=VS.103)
ms:contentKeyID: 36068731
ms.date: 06/28/2011
...
The [Pattern\<T1, T2, T3, T4\>](hh229732\(v=vs.103\).md) type exposes the following members.
