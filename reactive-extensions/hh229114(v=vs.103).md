---
title: Observable.Create(TSource) Method (Func(IObserver(TSource), IDisposable)) (System.Reactive.Linq)
TOCTitle: Create(TSource) Method (Func(IObserver(TSource), IDisposable))
ms:assetid: M:System.Reactive.Linq.Observable.Create``1(System.Func{System.IObserver{``0},System.IDisposable})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229114(v=VS.103)
ms:contentKeyID: 36068530
ms.date: 06/28/2011
