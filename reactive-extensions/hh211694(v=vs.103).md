---
title: VirtualTimeSchedulerBase(TAbsolute, TRelative) Methods (System.Reactive.Concurrency)
TOCTitle: VirtualTimeSchedulerBase(TAbsolute, TRelative) Methods
ms:assetid: Methods.T:System.Reactive.Concurrency.VirtualTimeSchedulerBase`2
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh211694(v=VS.103)
ms:contentKeyID: 36069140
ms.date: 06/28/2011
