---
title: HistoricalScheduler.Schedule Method  (System.Reactive.Concurrency)
TOCTitle: Schedule Method
ms:assetid: Overload:System.Reactive.Concurrency.HistoricalScheduler.Schedule
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.reactive.concurrency.historicalscheduler.schedule(v=VS.103)
ms:contentKeyID: 36069585
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Concurrency.HistoricalScheduler.Schedule
dev_langs:
- CSharp
- JScript
- VB
