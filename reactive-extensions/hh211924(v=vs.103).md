---
title: Pattern(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) Methods (System.Reactive.Joins)
TOCTitle: Pattern(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) Methods
ms:assetid: Methods.T:System.Reactive.Joins.Pattern`10
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh211924(v=VS.103)
ms:contentKeyID: 36069625
ms.date: 06/28/2011
...
The [Pattern\<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10\>](hh228972\(v=vs.103\).md) type exposes the following members.
