---
title: Pattern(T1, T2, T3, T4, T5) Methods (System.Reactive.Joins)
TOCTitle: Pattern(T1, T2, T3, T4, T5) Methods
ms:assetid: Methods.T:System.Reactive.Joins.Pattern`5
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229475(v=VS.103)
ms:contentKeyID: 36068891
ms.date: 06/28/2011
...
The [Pattern\<T1, T2, T3, T4, T5\>](hh211959\(v=vs.103\).md) type exposes the following members.
