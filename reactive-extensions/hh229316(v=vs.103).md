---
title: Pattern(T1, T2, T3, T4, T5, T6) Class (System.Reactive.Joins)
TOCTitle: Pattern(T1, T2, T3, T4, T5, T6) Class
ms:assetid: T:System.Reactive.Joins.Pattern`6
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229316(v=VS.103)
ms:contentKeyID: 36068733
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Joins.Pattern`6
dev_langs:
- CSharp
- JScript
- VB
