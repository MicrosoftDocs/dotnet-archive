---
title: Observable.ToAsync(T1, T2, T3, TResult) Method (Func(T1, T2, T3, TResult)) (System.Reactive.Linq)
TOCTitle: ToAsync(T1, T2, T3, TResult) Method (Func(T1, T2, T3, TResult))
ms:assetid: M:System.Reactive.Linq.Observable.ToAsync``4(System.Func{``0,``1,``2,``3})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229450(v=VS.103)
ms:contentKeyID: 36068866
ms.date: 06/28/2011
