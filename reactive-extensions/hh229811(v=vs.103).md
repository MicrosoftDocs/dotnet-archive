---
title: Pattern(T1, T2) Methods (System.Reactive.Joins)
TOCTitle: Pattern(T1, T2) Methods
ms:assetid: Methods.T:System.Reactive.Joins.Pattern`2
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229811(v=VS.103)
ms:contentKeyID: 36069482
ms.date: 06/28/2011
...
The [Pattern\<T1, T2\>](hh229293\(v=vs.103\).md) type exposes the following members.
