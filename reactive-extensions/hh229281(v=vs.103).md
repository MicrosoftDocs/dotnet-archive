---
title: Observable.SelectMany(TSource, TCollection, TResult) Method (IObservable(TSource), Func(TSource, IEnumerable(TCollection)), Func(TSource, TCollection, TResult)) (System.Reactive.Linq)
TOCTitle: SelectMany(TSource, TCollection, TResult) Method (IObservable(TSource), Func(TSource, IEnumerable(TCollection)), Func(TSource, TCollection, TResult))
ms:assetid: M:System.Reactive.Linq.Observable.SelectMany``3(System.IObservable{``0},System.Func{``0,System.Collections.Generic.IEnumerable{``1}},System.Func{``0,``1,``2})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229281(v=VS.103)
ms:contentKeyID: 36068696
ms.date: 06/28/2011
