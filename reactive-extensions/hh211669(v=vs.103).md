---
title: ISubject(T) Interface (System.Reactive.Subjects)
TOCTitle: ISubject(T) Interface
ms:assetid: T:System.Reactive.Subjects.ISubject`1
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh211669(v=VS.103)
ms:contentKeyID: 36069115
ms.date: 06/28/2011
...
Implementing the ISubject interface allows you to create your own subject with custom behaviors.

## Examples

The following example code implements a example subject which just echos method execution out to the console window.
