---
title: Observable.ToAsync(T1, T2, T3, T4, T5, TResult) Method (Func(T1, T2, T3, T4, T5, TResult)) (System.Reactive.Linq)
TOCTitle: ToAsync(T1, T2, T3, T4, T5, TResult) Method (Func(T1, T2, T3, T4, T5, TResult))
ms:assetid: M:System.Reactive.Linq.Observable.ToAsync``6(System.Func{``0,``1,``2,``3,``4,``5})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229571(v=VS.103)
ms:contentKeyID: 36068986
ms.date: 06/28/2011
