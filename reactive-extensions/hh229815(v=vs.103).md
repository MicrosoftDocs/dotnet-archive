---
title: Observable.Contains(TSource) Method (IObservable(TSource), TSource, IEqualityComparer(TSource)) (System.Reactive.Linq)
TOCTitle: Contains(TSource) Method (IObservable(TSource), TSource, IEqualityComparer(TSource))
ms:assetid: M:System.Reactive.Linq.Observable.Contains``1(System.IObservable{``0},``0,System.Collections.Generic.IEqualityComparer{``0})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229815(v=VS.103)
ms:contentKeyID: 36069486
ms.date: 06/28/2011
