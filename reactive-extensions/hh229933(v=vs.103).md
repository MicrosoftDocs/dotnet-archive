---
title: TaskPoolScheduler Class (System.Reactive.Concurrency)
TOCTitle: TaskPoolScheduler Class
ms:assetid: T:System.Reactive.Concurrency.TaskPoolScheduler
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/system.reactive.concurrency.taskpoolscheduler(v=VS.103)
ms:contentKeyID: 36069604
ms.date: 06/28/2011
...
<td><a href="https://msdn.microsoft.com/en-us/library/m:system.reactive.concurrency.taskpoolscheduler.#ctor(system.threading.tasks.taskfactory)(v=VS.103)">TaskPoolScheduler</a></td>
<td>Creates an object that schedules units of work using the provided TaskFactory.</td>
</tr>
</tbody>
</table>
