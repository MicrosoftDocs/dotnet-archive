---
title: Observable.TakeUntil(TSource, TOther) Method  (System.Reactive.Linq)
TOCTitle: TakeUntil(TSource, TOther) Method
ms:assetid: M:System.Reactive.Linq.Observable.TakeUntil``2(System.IObservable{``0},System.IObservable{``1})
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Hh229530(v=VS.103)
ms:contentKeyID: 36068946
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- System.Reactive.Linq.Observable.TakeUntil``2
dev_langs:
- CSharp
- JScript
- VB
