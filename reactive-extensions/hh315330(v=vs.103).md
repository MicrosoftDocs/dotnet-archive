---
title: MockDisposable.Sort Method  (ReactiveTests)
TOCTitle: Sort Method
ms:assetid: Overload:ReactiveTests.MockDisposable.Sort
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/reactivetests.mockdisposable.sort(v=VS.103)
ms:contentKeyID: 36621018
ms.date: 06/28/2011
mtps_version: v=VS.103
f1_keywords:
- ReactiveTests.MockDisposable.Sort
dev_langs:
- CSharp
- JScript
- VB
